...
class DQN_Agent:
    ...
    def choose_action(self, state, valid_moves):
        if np.random.rand() <= self.epsilon:
            ...
            #print("Q-values:", masked_q_values)
...
if __name__ == "__main__":
    ...
    #othello_chainer_rl.train_vs_dqn(100)  #Play 100 episodes
    ...
    dqn_agent.load_model('C:/Users/MongkolChut/Downloads/New folder/GymRandom/Finished/checkpoint/checkpoint_5000.npz')
